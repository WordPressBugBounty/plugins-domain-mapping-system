...
export default function Tooltip() {
    return (
        <div className="dms-n-config-table-info">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="15" height="15" viewBox="0,0,256,256">
                <g fill="#0085ba" fillRule="nonzero" stroke="none" strokeWidth="1"
                   strokeLinecap="butt" strokeLinejoin="miter" strokeMiterlimit="10"
                   strokeDasharray="" strokeDashoffset="0" fontFamily="none" fontSize="none"
            ...
            <div className="dms-n-config-table-info-text"
                 dangerouslySetInnerHTML={{__html: sprintf(__("Use the radio button to select a Microsite homepage. Read our %sdocumentation%s for details.", 'domain-mapping-system'), '<a href="https://docs.domainmappingsystem.com/features/creating-microsites-multisite-alternative" target="_blank">', '</a>')}}></div>
        </div>
    );
}